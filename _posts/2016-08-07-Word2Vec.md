...
:-------------------------:|
![an image alt text]({{ site.baseurl }}/images/word2vec1.png "Model") | 

![Figure 1]({{ site.baseurl }}/images/word2vec1.png "Model with one center word and one outside word"){:height="70%" width="70%"}
