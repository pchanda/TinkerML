...
$$\frac{\partial E}{\partial {\textbf{v}}_c} = -{\hat{\textbf{v}}}_o + \sum_{t=1}^{N_{\textbf{V}}} \lbrace \dfrac {\exp( {\hat{\textbf{v}}_t}^{T} {\textbf{v}}_c ) } {\sum_{k=1}^{N_{\textbf{V}}}  \exp({\hat{\textbf{v}}_k}^{T} {\hat{\textbf{v}}}_t)} \rbrace {\textbf{v}}_c  =  [p(w_t \vert w_c) - 1] {\hat{\textbf{v}}}_t $$
