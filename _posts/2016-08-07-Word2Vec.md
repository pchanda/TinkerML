...
$$\frac{\partial E}{\partial \hat{\textbf{v}}_o} = -{\textbf{v}}_c + \dfrac {\exp( {\hat{\textbf{v}}_j}^{T} {\textbf{v}}_c ) } {\sum_{t=1}^{N_{\textbf{V}}}  \exp({\hat{\textbf{v}}_t}^{T} {\textbf{v}}_c)} -{\textbf{v}}_c  =  \[p(w_o \vert w_c) - 1\] v_c$$
