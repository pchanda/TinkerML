...
\textbf{Model with one center word and one outside word}           |  
:-------------------------:|
![an image alt text]({{ site.baseurl }}/images/word2vec1.png "Model"){:height="40%" width="50%"} | 


\textbf{Model with one center word and one outside word}          
![an image alt text]({{ site.baseurl }}/images/word2vec1.png "Model"){:height="60%" width="60%"}
